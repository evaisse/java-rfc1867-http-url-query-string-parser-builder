...
public class ReplaceCallback {
    /**
     * Replaces with callback, with no limit to the number of replacements. Probably what you want
     * most of the time.
     */
     ...
     * @param limit The maximum number of replacements to make. A negative value indicates replace
     *     all.
     * @param count If this is not null, it will be set to the number of replacements made.
     * @param callback Callback function
     */
    public static String replace(
            String regex, String subject, int limit, AtomicInteger count, Callback callback) {
        ...
        if (count != null) count.set(i);
        return sb.toString();
    }

    public static interface Callback {
        /**
         * This function is called when a match is made. The string which was matched can be
         * obtained via match.group(), and the individual groupings via match.group(n).
         */
